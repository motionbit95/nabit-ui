    ...
    if (props.isRequired && !value) {
      ...
      if (pw.length < 8 || pw.length > 20) {
        ...
        setErr({
          code: "invalid-password",
          message:
            "Please enter a mixture of letters, numbers, and special characters.",
        });
      } else {
        setErr({
          code: null,
      ...
      <div className="input-form">
        ...
        <div className="input-wrapper">
          <div className="inner">
            ...
            />
            {label === "Password" && (
              <div className="icon" onClick={() => setIsPassword(!isPassword)}>
                {isPassword ? (
        ...
        {err.code && <div className="input-error-message">{err.message}</div>}
      </div>
    </div>
  );
};
